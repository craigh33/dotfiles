# Generated by Powerlevel10k configuration wizard on 2023-01-26 at 15:57 GMT.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent|kube|make'
  ...
  # You can define different colors, icons and content expansions for different classes:
  #
  typeset -g POWERLEVEL9K_KUBECONTEXT_TEST_FOREGROUND=10
  typeset -g POWERLEVEL9K_KUBECONTEXT_TEST_VISUAL_IDENTIFIER_EXPANSION='🔧'
  typeset -g POWERLEVEL9K_KUBECONTEXT_TEST_CONTENT_EXPANSION='> ${P9K_CONTENT} <'
  typeset -g POWERLEVEL9K_KUBECONTEXT_STG_FOREGROUND=11
  typeset -g POWERLEVEL9K_KUBECONTEXT_STG_VISUAL_IDENTIFIER_EXPANSION='👌'
  typeset -g POWERLEVEL9K_KUBECONTEXT_STG_CONTENT_EXPANSION='> ${P9K_CONTENT} <'
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_FOREGROUND=9
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_BACKGROUND=214
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEV_BACKGROUND=15
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEV_FOREGROUND=10
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEV_VISUAL_IDENTIFIER_EXPANSION='🔧'
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEV_CONTENT_EXPANSION='> ${P9K_CONTENT} <'
  typeset -g POWERLEVEL9K_KUBECONTEXT_LOCAL_FOREGROUND=15
  typeset -g POWERLEVEL9K_KUBECONTEXT_LOCAL_VISUAL_IDENTIFIER_EXPANSION='😎'
  typeset -g POWERLEVEL9K_KUBECONTEXT_LOCAL_CONTENT_EXPANSION='> ${P9K_CONTENT} <'
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
    '*-prd-*'            PROD
    '*-stg-*'            STG
    '*-dev-*'            DEV
